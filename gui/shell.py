...
class TitleBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.btn_tour = IconButton("search", t("جولة تعريفية بالبرنامج"),
                                   34, 16)
        self.btn_tour.clicked.connect(self.tourRequested)
        row.addWidget(self.btn_tour)
...
class FramelessWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.title_bar.tourRequested.connect(self.show_tour)
