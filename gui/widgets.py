...
def ltr(text: str) -> str:
    """
    يعزل نصًّا لاتينيًّا داخل واجهة عربية.

    بلا العزل يقلب محرّك الاتجاه ترتيب المقاطع اللاتينية داخل الفقرة العربية،
    فيصير «2026-08-27 19-28-32.mov» على الشاشة «mov.19-28-32 2026-08-27»
    و«1920×1080 · 60 fps» تصير «fps 60 · 1080×1920»: معلومة مقلوبة لا شكل
    رديء. يلزم كلَّ اسم ملف ومقاسٍ وترميزٍ يُعرض للمستخدم.
    """
    return "⁦%s⁩" % text          # LRI … PDI
