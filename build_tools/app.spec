...
"""
وصفة بناء وِن كَت ملفَّ exe مستقلًّا.
...
HIDDEN = [
    ...
    "%s.core.project" % PKG,
    "%s.core.tools" % PKG,
    "%s.core.transitions" % PKG,
    "%s.core.updater" % PKG,
    "%s.gui.backdrop" % PKG,
    "%s.gui.effects" % PKG,
    "%s.gui.export_dialog" % PKG,
    "%s.gui.icons" % PKG,
    "%s.gui.lettering" % PKG,
...
EXCLUDES = [
    ...
    # QtMultimedia و QtMultimediaWidgets لا تُستثنيان: عليهما
    # يقوم تشغيل المعاينة داخل البرنامج
    "PySide6.QtNfc",
